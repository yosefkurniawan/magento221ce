{
    ...
    optimizeCss: 'none',
    inlineText: true,
    baseUrl: "../static/frontend/MMID2018/default/en_US_source",
    dir: '../static/frontend/MMID2018/default/en_US',
    useSourceUrl: 'true',  // <<<<< Set to false in prod
    ...
    modules: [
        ...
        // Edit this bundle if you customize checkout
        {
            ...
            include: [
                ...
                // 'Magento_OfflineShipping/js/view/shipping-rates-validation/freeshipping',               // icube: add this
                // 'Magento_OfflineShipping/js/model/shipping-rates-validator/freeshipping',               // icube: add this
                // 'Magento_OfflineShipping/js/model/shipping-rates-validation-rules/freeshipping',        // icube: add this
                // 'Magento_Ui/js/form/element/post-code'                                                  // icube: add this
        ...
        // Product page bundle
        {
            ...
            include: [
                ...
                'Magento_Review/js/validate-review',                            // icube: add this
